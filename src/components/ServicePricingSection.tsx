...
const PLANS = [
  ...
  },
  {
    ...
    priceUnit: "만원 / 월",
    credits: "월 300개+",
    creditLabel: "핵심 지역 키워드 풀관리",
    description:
      "매달 핵심 지역 키워드 300개 이상 도배·노출까지 풀 관리. 클라이언트는 관리자 페이지를 건드릴 필요 없이 전담팀이 밀착 케어합니다.",
    features: [
      "Premium 전 기능 포함",
      "키워드 선정 · 발행 전담",
      "월 300개+ 자동 도배",
    ...
    <section id="pricing" className="scroll-mt-6 border-t border-slate-200 bg-gradient-to-b from-slate-50 to-white">
      <div className="mx-auto max-w-6xl px-4 py-16 lg:py-20">
            ...
            <div className="flex shrink-0 flex-wrap gap-4 lg:gap-6">
              <div className="text-center">
                ...
                <p className="text-xl font-bold text-slate-900">
                  50<span className="text-sm font-normal text-slate-500">만원</span>
                </p>
              </div>
              <div className="text-center">
                <p className="text-xs text-slate-500">월 관리</p>
                <p className="text-xl font-bold text-slate-900">
                  30<span className="text-sm font-normal text-slate-500">만원</span>
                </p>
              </div>
              <div className="text-center">
                <p className="text-xs text-slate-500">일일 발행</p>
                <p className="text-xl font-bold text-blue-600">
                  300<span className="text-sm font-normal text-slate-500">개까지</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <p className="mt-8 text-center text-xs text-slate-500">
          ※ 상기 요금은 VAT 별도 · 크레딧·기능은 계약 조건에 따라 조정 가능합니다.
        </p>
      </div>
    </section>
  );
