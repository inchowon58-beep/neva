const HIGHLIGHTS = [
  {
    ...
    description:
      "네이버 블로그는 로직 변경 시 지수가 통째로 날아갈 수 있습니다. Vercel 기반 독립 웹문서는 누락 위험이 낮고, 축적될수록 사이트 힘이 강해집니다.",
  ...
  },
  {
    ...
    description:
      "복붙 매크로가 아닙니다. 품종 유래·성격·털빠짐 등 10여 가지 전문 정보 풀에서 매번 랜덤 4개를 골라 H2 구조로 발행 — 검색엔진이 선호하는 고품질 문서.",
  ...
  },
  {
    ...
    description:
      "저가형 자동화는 텍스트가 똑같아 금방 누락됩니다. 품종별 데이터 풀 랜덤 조합 + 상단 키워드 동적 배치로 매번 다른 독창적 문서를 생성합니다.",
    accent: "from-emerald-500/10 to-emerald-600/5 border-emerald-200/60",
  },
  {
    icon: "🔔",
    title: "Discord 웹훅 실시간 알림",
    description:
      "페이지 새 발행·상담 신청 시 사장님 휴대폰 Discord 앱으로 띵동! 실시간 보고가 포함되어 월 구독료가 전혀 아깝지 않게 느껴집니다.",
